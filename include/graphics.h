...
extern const u32 gBallGfx_Rogue[];
extern const u32 gBallPal_Rogue[];
...
extern const u32 gBattleTerrainPalette_BuildingSimulator[];
...
extern const u32 gItemIconPalette_RogueBall[];
...
#define gItemIconPalette_DevonGoods gItemIconPalette_DevonParts
extern const u32 gItemIconPalette_DevonGoodsBrown[];
...
extern const u32 gItemIconPalette_GalarStone[];
extern const u32 gItemIcon_HisuiStone[];
extern const u32 gItemIconPalette_HisuiStone[];
extern const u32 gItemIcon_FieldMoves[];
extern const u32 gItemIconPalette_FieldMoves[];
...
extern const u32 gItemIconPalette_TypeFighting[];
extern const u32 gItemIcon_TypeFlying[];
extern const u32 gItemIconPalette_TypeFlying[];
extern const u32 gItemIcon_TypePoison[];
extern const u32 gItemIconPalette_TypePoison[];
extern const u32 gItemIcon_TypeGround[];
extern const u32 gItemIconPalette_TypeGround[];
extern const u32 gItemIcon_TypeRock[];
extern const u32 gItemIconPalette_TypeRock[];
extern const u32 gItemIcon_TypeBug[];
extern const u32 gItemIconPalette_TypeBug[];
extern const u32 gItemIcon_TypeGhost[];
extern const u32 gItemIconPalette_TypeGhost[];
extern const u32 gItemIcon_TypeSteel[];
extern const u32 gItemIconPalette_TypeSteel[];
extern const u32 gItemIcon_TypeMystery[];
extern const u32 gItemIconPalette_TypeMystery[];
extern const u32 gItemIcon_TypeFire[];
extern const u32 gItemIconPalette_TypeFire[];
extern const u32 gItemIcon_TypeWater[];
extern const u32 gItemIconPalette_TypeWater[];
extern const u32 gItemIcon_TypeGrass[];
extern const u32 gItemIconPalette_TypeGrass[];
extern const u32 gItemIcon_TypeElectric[];
extern const u32 gItemIconPalette_TypeElectric[];
extern const u32 gItemIcon_TypePsychic[];
extern const u32 gItemIconPalette_TypePsychic[];
extern const u32 gItemIcon_TypeIce[];
extern const u32 gItemIconPalette_TypeIce[];
extern const u32 gItemIcon_TypeDragon[];
extern const u32 gItemIconPalette_TypeDragon[];
extern const u32 gItemIcon_TypeDark[];
...
extern const u32 gBagScreen_GfxTileMapTMHM[];
