...
extern const u8 gText_ExpandedPlaceholder_RemotePlayer[];
...
extern const u8 gText_Stones[];
extern const u8 gText_Pokeblock[];
...
extern const u8 gMenuText_SortType[];
extern const u8 gMenuText_SortName[];
extern const u8 gMenuText_SortValue[];
extern const u8 gMenuText_SortAmount[];
...
extern const u8 gText_MenuSoftlockTP[];
...
extern const u8 gText_SavingQuests[];
...
extern const u8 gText_AutoRunHold[];
extern const u8 gText_AutoRunToggle[];
extern const u8 gText_TextNicknameAsk[];
extern const u8 gText_TextNicknameAlways[];
extern const u8 gText_TextNicknameNever[];
extern const u8 gText_TextNicknameRandom[];
...
extern const u8 gText_OptionGame[];
extern const u8 gText_OptionGraphics[];
extern const u8 gText_OptionUI[];
extern const u8 gText_OptionAudio[];
...
extern const u8 gText_SoundLowHealth[];
...
extern const u8 gText_MainMenuContinueRun[];
...
extern const u8 gText_ContinueMenuQuests[];
...
extern const u8 gText_CancelStarterChoice[];
...
extern const u8 gText_CantBeUsedNot[];
...
extern const u8 gText_ConfirmTossItems[];
extern const u8 gText_MoveVar1Where[];
extern const u8 gText_SortedByWhat[];
extern const u8 gText_SortedByName[];
extern const u8 gText_SortedByType[];
extern const u8 gText_SortedByValue[];
...
extern const u8 gText_MoveRelearnerNotEnoughMoney[];
extern const u8 gText_MoveRelearnerBattleMoves[];
extern const u8 gText_MoveRelearnerPP[];
extern const u8 gText_MoveRelearnerPower[];
extern const u8 gText_MoveRelearnerAccuracy[];
extern const u8 gText_MoveRelearnerCostCanBuy[];
extern const u8 gText_MoveRelearnerCostCannotBuy[];
...
extern const u8 gText_PokedollarAlreadyOwned[];
extern const u8 gText_BuildVar1[];
extern const u8 gText_YouDontHaveMoney[];
extern const u8 gText_Var1CertainlyHowMany2[];
extern const u8 gText_Var1CertainlyHowMany[];
extern const u8 gText_Var1FromVar2FromVar3BuildDirection[];
extern const u8 gText_Var1IsItThatllBeVar2[];
extern const u8 gText_BuildVar1InThatllBeVar2[];
extern const u8 gText_BuildVar1InVar2ThatllBeVar3[];
extern const u8 gText_YouWantedVar1ThatllBeVar2[];
extern const u8 gText_InBagVar1[];
extern const u8 gText_FromVar1[];
...
extern const u8 gText_PokedexMovesCustom[];
...
extern const u8 gText_PokedexEvoLevelMale[];
extern const u8 gText_PokedexEvoLevelFemale[];
...
extern const u8 gText_CannotExpandSouth[];
extern const u8 gText_CannotExpandNorth[];
extern const u8 gText_CannotExpandEast[];
extern const u8 gText_CannotExpandWest[];
...
extern const u8 gText_WagerMoney[];
extern const u8 gText_WagerIVs[];
extern const u8 gText_WagerItems[];
