...
static inline u32 CalcMoveBasePowerAfterModifiers(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk, u32 weather)
{
    ...
    case EFFECT_ELECTRO_SHOT:
        if (IsBattlerWeatherAffected(battlerAtk, (B_WEATHER_HAIL | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_SNOW)))
            modifier = uq4_12_multiply(modifier, UQ_4_12(0.5));
        break;
        ...
        for (i = 0; TRUE; i++)
        {
            ...
            if (method == formChange.method && species != formChange.targetSpecies)
            {
                ...
                case FORM_CHANGE_BATTLE_SWITCH:
                    if (formChange.param1 == GetBattlerAbility(battler) || formChange.param1 == ABILITY_NONE)
                        targetSpecies = formChange.targetSpecies;
                    break;
                ...
                case FORM_CHANGE_BATTLE_TERASTALLIZATION:
                    if (GetBattlerTeraType(battler) == formChange.param1)
                        targetSpecies = formChange.targetSpecies;
                    break;
                }
            }
...
u32 GetBattlerMoveTargetType(u32 battler, u32 move)
{
    ...
    else if (gBattleMoves[move].effect == EFFECT_EXPANDING_FORCE
